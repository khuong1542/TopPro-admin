...
! function(a, b) { "object" == typeof exports && "undefined" != typeof module ? module.exports = b() : "function" == typeof define && define.amd ? define(b) : a.moment = b() }(this, function() {
    ...
    function hc() { return this.clone().locale("en").format("ddd DD MM YYYY HH:mm:ss [GMT]ZZ") }
    ...
    var zd, Ad = yd,
        ...
        Cd = { LTS: "h:mm:ss A", LT: "h:mm A", L: "DD/MM/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" },
        Dd = "Invalid date",
        Ed = "%d",
        Fd = /\d{1,2}/,
    ...
    var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        ...
        qe = "Tháng 1_Tháng 2_Tháng 3_Tháng 4_Tháng 5_Tháng 6_Tháng 7_Tháng 8_Tháng 9_Tháng 10_Tháng 11_Tháng 12".split("_"),
        re = be,
        se = be;
    ...
    var Be, Ce = /[ap]\.?m?\.?/i,
        ...
        Me = /^\/?Date\((\-?\d+)/i,
        Ne = /^((?:Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d?\d\s(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Thang12)\s(?:\d\d)?\d\d\s)(\d\d:\d\d)(\:\d\d)?(\s(?:UT|GMT|[ECMP][SD]T|[A-IK-Za-ik-z]|[+-]\d{4}))$/;
